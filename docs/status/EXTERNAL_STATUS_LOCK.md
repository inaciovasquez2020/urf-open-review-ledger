...
Status: **SCAFFOLD_OR_LEGACY**

Scope:

Scaffold, legacy, dashboard, witness, formalization shell, or audit wrapper. It must not be described as an independent theorem proof.
